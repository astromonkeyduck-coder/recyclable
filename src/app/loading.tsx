...
function SegmentedRing({ reduceMotion }: { reduceMotion?: boolean }) {
  const size = 80;
  const stroke = 5;
...
export default function Loading() {
  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center px-4 py-16">
      ...
      >
        {/* Spinner */}
        <SegmentedRing reduceMotion={!!reduceMotion} />
        ...
        >
          ...
          <div className="space-y-2.5">
            <ShimmerBar width="85%" delay={0} reduceMotion={!!reduceMotion} />
            <ShimmerBar width="70%" delay={0.1} reduceMotion={!!reduceMotion} />
            <ShimmerBar width="60%" delay={0.2} reduceMotion={!!reduceMotion} />
          </div>
          <div className="mt-4 h-px bg-border" />
          <div className="mt-3 flex justify-between">
            <ShimmerBar width="40%" delay={0.3} reduceMotion={!!reduceMotion} />
            <ShimmerBar width="20%" delay={0.4} reduceMotion={!!reduceMotion} />
          </div>
        </motion.div>
